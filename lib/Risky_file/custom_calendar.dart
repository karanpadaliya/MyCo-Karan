                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            widget.leftArrowBackgroundColor ??
                            AppColors.primary,
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          final firstDay =
                              widget.totalPreviousYear ?? DateTime.utc(2020, 1);
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            widget.rightArrowBackgroundColor ??
                            AppColors.primary,
              ...
              ..._currentlySelectedDays.map((day) {
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      Container(
                        width: 118, // Fixed width for the date container
                          ...
                          child: Column(
                            ...
                            children: [
                              FittedBox(
                                fit:
                                    BoxFit
                                        .scaleDown, // Shrink text if it's too large
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize:
                                        ...
                                        MediaQuery.of(
                                          context,
                                        ).textScaleFactor, // Scale with textScaleFactor
                                  ),
                                ),
                              ),
                              FittedBox(
                          ...
                          children: [
                            Expanded(
                              child: Radio<String>(
                                ...
                                onChanged:
                                    (val) => _onLeaveTypeChanged(day, val!),
                                activeColor: const Color(0xFF2F648E),
                              ),
                            ),
                            Expanded(
